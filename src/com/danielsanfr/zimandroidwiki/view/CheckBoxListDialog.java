...
public class CheckBoxListDialog extends DialogFragment {
	...
	private CheckBoxListDialogListener checkBoxListDialogListener;

	public interface CheckBoxListDialogListener {
		void onFinishCheckBoxListDialog(ListCommand command, List<String> selectedItems);
	}
	...
	public void show(ListCommand command,
			CheckBoxListDialogListener checkBoxListDialogListener,
			FragmentManager manager, String tag) {
		// TODO Auto-generated method stub
		this.command = command;
		this.checkBoxListDialogListener = checkBoxListDialogListener;
				...
				.setPositiveButton(getArguments().getString(ARG_TITLE_BUTTON),
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								// validation code
								checkBoxListDialogListener.onFinishCheckBoxListDialog(
